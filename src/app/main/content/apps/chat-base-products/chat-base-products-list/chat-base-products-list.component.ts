...
@Component({
  selector: "app-chat-base-products-list",
  templateUrl: "./chat-base-products-list.component.html",
  styleUrls: ["./chat-base-products-list.component.scss"],
  animations: fuseAnimations
})
export class ChatBaseProductsListComponent implements OnInit {
